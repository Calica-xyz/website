<!-- NOTE: This is a forked copy from https://github.com/themesberg/flowbite-svelte/blob/main/src/lib/cards/Card.svelte -->
<script lang="ts">
  ...
  $: cardClass = classNames(
    ...
    horizontal &&
      (reverse ? "md:flex-row-reverse md:max-w-xl" : "md:flex-row md:max-w-xl"),
