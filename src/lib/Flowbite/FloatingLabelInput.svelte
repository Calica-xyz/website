<script lang="ts">
  ...
  import generateId from "$lib/Flowbite/utils/generateId.js";
  ...
  const inputColorClasses = {
    base: "border-gray-300 dark:border-gray-600 dark:focus:border-primary focus:border-primary",
    green:
  ...
  const labelColorClasses = {
    base: "text-gray-500 dark:text-gray-400 peer-focus:text-primary peer-focus:dark:text-primary",
...
<div class={classNames(divClasses[style], $$props.parentClass)}>
  <input
    {id}
    {...$$restProps}
    bind:value
