<script lang="ts">
  ...
  const colorClasses = {
    base: "border-gray-300 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500",
    green:
