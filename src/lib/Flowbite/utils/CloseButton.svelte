<script lang="ts">
  ...
  const colors = {
    ...
    yellow:
      "focus:ring-yellow-400 hover:bg-yellow-200 dark:hover:bg-yellow-300",
    green: "focus:ring-green-400 hover:bg-green-200 dark:hover:bg-green-300",
    indigo:
      "focus:ring-indigo-400 hover:bg-indigo-200 dark:hover:bg-indigo-300",
    purple:
      "focus:ring-purple-400 hover:bg-purple-200 dark:hover:bg-purple-300",
  ...
  const sizing = {
    xs: "m-0.5 rounded focus:ring-1",
    sm: "m-0.5 rounded focus:ring-1",
    md: "-mx-1 -my-1.5 rounded-lg focus:ring-2",
  };
