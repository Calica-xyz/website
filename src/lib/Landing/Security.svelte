  ...
  <div class="m-auto max-w-7xl flex flex-wrap gap-20 items-center">
    <div class="flex-1 min-w-[min(320px,100%)]">
      <div>
        <div>
          <span
            class="text-primary-300 flex h-12 w-12 items-center justify-center rounded-md"
          >
            <LockClosed size="50" />
          </span>
        </div>
        <div class="mt-6">
          <h2
            class="text-4xl font-bold tracking-tight text-gray-800 lg:text-5xl"
          >
            Calica is secure
          </h2>
          ...
          <ul class="mt-2">
            ...
            <li class="my-2 flex gap-2">
              ...
              <p class="text-md text-gray-500">
                ...
                evaluates vulnerabilities and gas optimizations.
              </p>
            </li>
            <li class="my-2 flex gap-2">
              <Check class="text-primary-300" />
        ...
        <blockquote>
          <div>
            <p class="text-base text-gray-500">
              &ldquo;I can confirm that your contract did not appear to eat the
              money from [our] sales.&rdquo;
            </p>
          </div>
          <footer class="mt-3">
            <div class="flex items-center space-x-3">
              <div class="flex-shrink-0">
                <img class="h-6 w-6 rounded-full" src="/ChrisK.jfif" alt="" />
              </div>
    ...
    <div class="m-auto flex-1 min-w-[min(320px,95%)] max-w-[500px]">
      <svg
        ...
        ><path
          ...
          transform="translate(-190.46477 -158)"
          fill="#f1f1f1"
        /><path
        ...
        /><path
          ...
          fill="#227fbc"
        /><path
          d="M381.68877,215.28648V499.53673S250.79593,436.53013,251.95428,270.887Z"
          transform="translate(-190.46477 -158)"
          opacity="0.1"
        /><polygon
          ...
          fill="#fff"
        /><path
          d="M1008.53523,742h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
          transform="translate(-190.46477 -158)"
          fill="#cacaca"
        /><polygon
